...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CargoConfirmationRequest {
    /// Parcel ID
    #[prost(string, tag = "1")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CargoConfirmationResponse {
    /// True if confirmed
    #[prost(bool, tag = "1")]
    pub success: bool,
}
...
pub mod rpc_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn cargo_confirmation(
            &mut self,
            request: impl tonic::IntoRequest<super::CargoConfirmationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CargoConfirmationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/grpc.RpcService/cargoConfirmation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("grpc.RpcService", "cargoConfirmation"));
            self.inner.unary(req, path, codec).await
        }
    }
}
